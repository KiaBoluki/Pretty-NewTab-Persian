...
setInterval(() => {
  ...
  lblTime.textContent = `
  ${( getDateTime().Hour < 10 ) ? '0' + getDateTime().Hour :  getDateTime().Hour }:
  ${( getDateTime().Minutes < 10 ) ? '0' + getDateTime().Minutes :  getDateTime().Minutes }:
  ${( getDateTime().Seconds < 10 ) ? '0' + getDateTime().Seconds :  getDateTime().Seconds } `;
